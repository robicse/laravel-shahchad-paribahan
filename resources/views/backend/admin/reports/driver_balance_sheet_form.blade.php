...
@section('content')
    <main class="app-content">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Driver Balance Sheet</h3>
                <div class="tile-body tile-footer">
                    ...
                    @endif
                    <form method="post" action="{{ route('admin.report-driver-balance-sheet') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <a href="{!! route('admin.get-report-driver-balance-sheet') !!}" class="btn btn-primary" type="button"><i class="fa fa-refresh"> Reset</i></a>
                            </div>
                        </div>
                    </form>
                    <div class="card-header">
                        <h3 class="card-title float-left">Driver Balance Sheet from date {{ $date_from }} to date {{ $date_to }}</h3>
