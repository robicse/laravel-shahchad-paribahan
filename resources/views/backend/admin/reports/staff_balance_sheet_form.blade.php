        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body tile-footer">
                    ...
                    <h5 align="center">Staff Balance Sheet from date {{ $date_from }} to date {{ $date_to }}</h5>
...
{{--                        </tr>--}}
            ...
            <div class="text-center">
                <a href="{{ url('/admin/report/staff-balance-sheet-print/'.$date_from.'/'.$date_to) }}" target="_blank" class="btn btn-sm btn-primary float-left">Print</a>
            </div>
            @endif
        </div>
    </main>
