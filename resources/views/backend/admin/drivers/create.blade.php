                ...
                <form role="form" action="{{route('admin.drivers.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="driving_licence_no" id="driving_licence_no" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="driving_experience_duration">Driving Experience Duration</label>
                            <input type="text" class="form-control" name="driving_experience_duration" id="driving_experience_duration" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="salary">Salary</label>
                            <input type="number" class="form-control" name="salary" id="salary" placeholder="">
                        </div>
{{--                        <div class="form-group">--}}
